...
export function ListItem({ title, subtitle, leading, trailing, showDisclosure = true, onPress, disabled = false, accessibilityLabel, accessibilityHint, style, testID }: ListItemProps) {
