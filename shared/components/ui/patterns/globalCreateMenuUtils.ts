...
export const globalCreateTargets = ['event', 'animal', 'note', 'objective', 'contact', 'wish'] as const;
...
export const globalCreateChoices: readonly GlobalCreateChoice[] = [
  ...
  { id: 'wish', label: 'Souhait', description: 'Garder une idée avec son prix éventuel', icon: 'wish' },
];
