...
export interface TabBarProps<TId extends string = string> { items: readonly TabBarItem<TId>[]; activeId: TId; onSelect: (id: TId) => void; disabled?: boolean; style?: StyleProp<ViewStyle> }

export function TabBar<TId extends string>({ items, activeId, onSelect, disabled = false, style }: TabBarProps<TId>) {
