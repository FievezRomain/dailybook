...
export interface SnackbarProps { visible: boolean; message: string; tone?: FeedbackTone; actionLabel?: string; onAction?: () => void; onHidden?: () => void; testID?: string }

export function Snackbar({ visible, message, tone = 'info', actionLabel = 'Réessayer', onAction, onHidden, testID }: SnackbarProps) {
