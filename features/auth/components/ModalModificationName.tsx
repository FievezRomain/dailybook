      ...
      <View style={styles.form}>
        <View style={styles.containerActionsButtons}>
          ...
          <View style={{ width: '33.33%', alignItems: 'center' }}>
            <Text style={[styles.textFontBold, { color: (colors as any).default_dark }]}>Nom d'utilisateur</Text>
          </View>
        ...
        <KeyboardAwareScrollView extraScrollHeight={-250} contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
          <View style={styles.formContainer}>
            <View style={{ marginBottom: 10 }}>
              <Text style={[styles.textFontBold, { marginBottom: 5 }, { color: (colors as any).default_dark }]}>Votre nom d'utilisateur reste privé.</Text>
              <Text style={{ color: (colors as any).default_dark }}>Ce nom est uniquement utilisé dans votre application sur votre téléphone.</Text>
              <Text style={{ color: (colors as any).default_dark }}>Il n'est jamais partagé avec d'autres utilisateurs ni utilisé dans nos traitements internes.</Text>
            </View>
            <View style={styles.inputContainer}>
              <Text style={[styles.textInput, styles.textFontRegular, { color: (colors as any).default_dark }]}>Nom : </Text>
