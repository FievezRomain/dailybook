    ...
    <View style={styles.loadingEvent}>
      ...
      <View style={{ position: 'absolute', bottom: 0, marginBottom: 50 }}>
        <View style={{ flexDirection: 'row' }}>
          <Text style={[{ color: (colors as any).quaternary, fontSize: 22 }, styles.textFontRegular]}>From</Text>
          <Text style={[{ color: (colors as any).neutral, fontSize: 22 }, styles.textFontRegular]}> Vasco & Co</Text>
        </View>
        <View style={{ flexDirection: 'column' }}>
          <Text style={[styles.textFontRegular, { color: (colors as any).neutral, textAlign: 'center' }]}>
