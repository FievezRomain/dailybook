    ...
    <ModalEditGeneric isVisible={modalVisible} setVisible={setModalVisible} arrayHeight={['25%']}>
      <View style={styles.card}>
        <View style={{ alignItems: 'center' }}>
          <Text style={[styles.textFontRegular, { color: (colors as any).default_dark }]}>Gérer le contact</Text>
          {contact !== null && (
            <Text style={[{ fontSize: 12 }, styles.textFontBold, { color: (colors as any).default_dark }]}>{contact.nom}</Text>
          )}
        </View>
