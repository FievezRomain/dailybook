            ...
            <View style={styles.rubriqueContainer}>
              <View style={styles.iconsContainer}>
                <TouchableOpacity style={{ width: '50%', alignItems: 'center', justifyContent: 'center', flexDirection: 'row' }} onPress={() => { setActiveRubrique(0); moveSeparator(0); }}>
                  <SimpleLineIcons name="target" size={20} color={activeRubrique === 0 ? colors.textPrimary : colors.surfaceVariant} style={{ marginRight: 5 }} />
                  <Text style={[{ color: activeRubrique === 0 ? colors.textPrimary : colors.surfaceVariant }, styles.textFontMedium]}>Objectifs</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{ width: '50%', alignItems: 'center', flexDirection: 'row', justifyContent: 'center' }} onPress={() => { setActiveRubrique(1); moveSeparator(1); }}>
                  <FontAwesome name="pie-chart" size={20} color={activeRubrique === 1 ? colors.textPrimary : colors.surfaceVariant} style={{ marginRight: 5 }} />
                  <Text style={[{ color: activeRubrique === 1 ? colors.textPrimary : colors.surfaceVariant }, styles.textFontMedium]}>Statistiques</Text>
                </TouchableOpacity>
              </View>
