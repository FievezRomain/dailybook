    ...
    <View style={styles.eventTextContainer}>
      ...
      <View style={styles.contentEventContainer}>
        ...
        {isValidString(eventInfos.traitement) && (
          <View style={{ paddingRight: 5, paddingBottom: 5 }}>
            <Text style={[styles.eventCommentaire, styles.text, styles.textFontRegular]}>
              <Text style={[{ fontStyle: 'italic', color: colors.textPrimary }, styles.textFontRegular]}>Traitement : </Text>
        ...
        {isValidString(eventInfos.datefinsoins) && (
          <View style={{ paddingRight: 5, paddingBottom: 5 }}>
            <Text style={[styles.eventCommentaire, styles.text, styles.textFontRegular]}>
              <Text style={[{ fontStyle: 'italic', color: colors.textPrimary }, styles.textFontRegular]}>Date de fin : </Text>
