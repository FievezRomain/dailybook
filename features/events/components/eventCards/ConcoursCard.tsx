    ...
    <View style={styles.eventTextContainer}>
      ...
      <View style={styles.contentEventContainer}>
        ...
        {isValidString(eventInfos.discipline) && (
          <View style={{ paddingRight: 5, paddingBottom: 5 }}>
            <Text style={[styles.eventCommentaire, styles.text, styles.textFontRegular]}>
              <Text style={[{ fontStyle: 'italic', color: colors.textPrimary }, styles.textFontRegular]}>Discipline : </Text>
        ...
        {isValidString(eventInfos.epreuve) && (
          <View style={{ paddingRight: 5, paddingBottom: 5 }}>
            <Text style={[styles.eventCommentaire, styles.text, styles.textFontRegular]}>
              <Text style={[{ fontStyle: 'italic', color: colors.textPrimary }, styles.textFontRegular]}>Épreuve : </Text>
              {eventInfos.epreuve}
            </Text>
          </View>
        )}
        {isValidString(eventInfos.dossart) && (
          <View style={{ paddingRight: 5, paddingBottom: 5 }}>
            <Text style={[styles.eventCommentaire, styles.text, styles.textFontRegular]}>
              <Text style={[{ fontStyle: 'italic', color: colors.textPrimary }, styles.textFontRegular]}>Dossart : </Text>
              {eventInfos.dossart}
            </Text>
          </View>
        )}
        {isValidString(eventInfos.placement) && (
          <View style={{ paddingRight: 5, paddingBottom: 5 }}>
            <Text style={[styles.eventCommentaire, styles.text, styles.textFontRegular]}>
              <Text style={[{ fontStyle: 'italic', color: colors.textPrimary }, styles.textFontRegular]}>Placement : </Text>
        ...
        {eventInfos.note != null && (
          <View style={{ paddingRight: 5, paddingBottom: 5 }}>
            <Text style={[styles.eventCommentaire, styles.text, styles.textFontRegular]}>
              <Text style={[{ fontStyle: 'italic', color: colors.textPrimary }, styles.textFontRegular]}>Note : </Text>
              {eventInfos.note} / 5
            </Text>
          </View>
        )}
