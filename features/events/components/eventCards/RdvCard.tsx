    ...
    <View style={styles.eventTextContainer}>
      ...
      <View style={styles.contentEventContainer}>
        ...
        {isValidString(eventInfos.specialiste) && (
          <View style={{ paddingRight: 5, paddingBottom: 5 }}>
            <Text style={[styles.eventCommentaire, styles.text, styles.textFontRegular]}>
              <Text style={[{ fontStyle: 'italic', color: (colors as any).default_dark }, styles.textFontRegular]}>Spécialiste : </Text>
              {eventInfos.specialiste}
            </Text>
          </View>
        )}
        {eventInfos.depense != null && (
          <View style={{ paddingRight: 5, paddingBottom: 5 }}>
            <Text style={[styles.eventCommentaire, styles.text, styles.textFontRegular]}>
              <Text style={[{ fontStyle: 'italic', color: (colors as any).default_dark }, styles.textFontRegular]}>Dépense : </Text>
              {eventInfos.depense ? parseFloat(eventInfos.depense).toFixed(2) : eventInfos.depense} euros
            </Text>
          </View>
        )}
