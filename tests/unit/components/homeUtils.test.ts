...
describe('homeUtils', () => {
  ...
  it('limite les prochains jours aux sept jours suivant aujourd’hui', () => { const result = splitHomeEvents([event(1, '2026-08-10'), event(2, '2026-08-16'), event(3, '2026-08-17')], new Date('2026-08-09T12:00:00')); expect(result.upcoming.map(({ id }) => id)).toEqual([1, 2]); });
