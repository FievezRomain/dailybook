...
function ModalMultiSelect<T extends Record<string, any>>({
  ...
  const isSelected = (item: T) : boolean => {
    return !!selected && selected.some((selectedItem: T) => selectedItem[valueKey] === item[valueKey]);
  }
      ...
      <View style={styles.itemContainer}>
        {list.map((item) => {
          ...
          return renderItem ? (
            ...
            >
              <Text style={[styles.title, styles.textFontRegular]}>
        ...
        {customizable && (
          <TouchableOpacity
            style={[styles.item, styles.disabled]}
            disabled={true}
          >
            <Text
              style={[
